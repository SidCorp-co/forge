...
## [Unreleased]
- Failed pipeline jobs now record which retry policy applied and which classifier judged them, so operator views and alerts stop missing whole classes of failure.
