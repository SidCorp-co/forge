...
### Fixed
- **A box running out of room now says so before it runs out.** It reads free bytes and free inodes where runs write scratch, names which is short, and says the worktree sweep will not reclaim it.
