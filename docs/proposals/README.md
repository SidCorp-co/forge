...
| [memory-v2-cognitive-layer.md](memory-v2-cognitive-layer.md) | Draft | v0.2 (hybrid retrieval, usage tracking, dedup, decay) → v0.3 (extraction, consolidation) → later (graph retrieval, global scope) |
