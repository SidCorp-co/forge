...
|---|---|---|---|
| [agent-driven-pipeline.md](agent-driven-pipeline.md) | Phases 0–4 shipped; **bundled skill set and runner-written verdict reversed 2026-09-02** (driver is now `issue-flow` from the forge plugin; nothing stops a self-written approval — priced in the file); phase 5 awaiting evidence | 2026-09-02 | upgrade to an RFC once the mode switch + status vocabulary are agreed |
