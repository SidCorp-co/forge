...
- **North star: one person who truly understands and engages with their projects, operating N of them through agents — watching, not working; joining only when an agent is truly stuck.** The qualifier is understanding and engagement, not seniority.
