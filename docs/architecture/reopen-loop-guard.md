...
## Operator exits at the cap — the first died with it

Both are recorded because the escalation comments the cap posted still sit in the issue history, and the first of them names an action the product no longer offers.
