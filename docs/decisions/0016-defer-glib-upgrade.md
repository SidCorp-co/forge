...
2. **glib 0.18 gets a backport patch** for `VariantStrIter` — would close the alert at the current pin without an ecosystem move. Watch: [glib changelog on crates.io](https://crates.io/crates/glib/0.18.5).
