 ...
 * ported to packages/core. The page still renders (skeletons, empty states)
    ...
    <div className="flex items-start gap-3 rounded border border-amber-500/40 bg-amber-500/10 p-4 text-amber-900 dark:text-amber-200">
      ...
      <div className="space-y-1 text-sm">
        ...
        <p className="text-xs opacity-80">
          {hint ??
            'This page will return once the underlying endpoint ships on packages/core. Phase 2.6 kept the route alive to preserve navigation; no network request is made.'}
        </p>
      </div>
    </div>
  );
