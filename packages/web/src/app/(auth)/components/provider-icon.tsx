import type { OAuthProviderId } from '@/lib/api/oauth-api';

/** Inline SVGs so the auth page doesn't pay a network round-trip per icon. */
export function ProviderIcon({ id }: { id: OAuthProviderId }) {
  ...
  // Generic OIDC — neutral key icon so corporate SSO doesn't borrow a
  // recognised logo.
  return (
    <svg
      aria-hidden
