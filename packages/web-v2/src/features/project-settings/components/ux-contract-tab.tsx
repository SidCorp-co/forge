				...
				<CardContent>
					...
					<div className="flex flex-wrap items-center gap-2">
						...
						<Button
							variant="primary"
							disabled={!canEdit}
							title={canEdit ? undefined : "Requires project admin"}
					...
					{!canEdit && (
						<p className="fg-caption mt-2 text-muted">
							Read-only — applying a preset requires a project admin.
						</p>
					)}
				</CardContent>
			</Card>
				...
				<CardContent>
					<div className="flex items-center justify-between gap-3">
						...
						{canEdit ? (
							...
							<Tooltip label="Requires project admin">
...
function RuleRow({
	...
	return (
		<div className="flex items-start justify-between gap-3 rounded-md border border-line bg-surface p-3">
			...
			<Tooltip label={canEdit ? "must ↔ should" : "Requires project admin"}>
				<Toggle
