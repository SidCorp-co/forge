...
export const COMPACT_TAG_CLASS: Record<string, string> = {
  ...
  table: "w-full border-collapse text-left text-12-5",
  thead: "",
  tbody: "",
  tr: "",
  ...
  i: "italic",
  em: "italic",
  kbd: "rounded-sm border border-line bg-sunken px-1 font-mono text-11-5",
...
export const CODE_BLOCK_CLASS =
  "block overflow-x-auto rounded-md bg-sunken p-3 font-mono text-12-5 text-fg";

export const CODE_INLINE_CLASS =
  "rounded-sm bg-sunken px-1 py-0.5 font-mono text-12-5 text-fg";
