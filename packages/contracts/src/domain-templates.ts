...
export const DOMAIN_TEMPLATES: DomainTemplate[] = [
	{
		...
		label: "Issue Tracker",
		description:
			"Bug tracking, feature requests, and project issue management.",
		isBuiltIn: true,
	...
	},
	{
		...
		description:
			"Project task tracking with workflows, assignments, and deadlines.",
		isBuiltIn: true,
	...
	},
	{
		...
		description:
			"HR administration, employee self-service, attendance, leave, and payroll.",
		isBuiltIn: true,
	...
	},
	{
		...
		description:
			"Sales pipeline, customer contacts, deals, and relationship tracking.",
		isBuiltIn: true,
	...
	},
	{
		...
		description:
			"Customer support tickets, SLA tracking, and knowledge base assistance.",
		isBuiltIn: true,
	...
	},
	{
		...
		description:
			"Documentation, wiki articles, FAQs, and organizational knowledge management.",
		isBuiltIn: true,
