...
export const UPDATE_PACKET_INTENT_CLASSES = [
	"invariant",
	"procedure",
	"enhancement",
] as const;
export type UpdatePacketIntentClass =
	(typeof UPDATE_PACKET_INTENT_CLASSES)[number];
...
export type UpdatePacketProvenance = z.infer<
	typeof updatePacketProvenanceSchema
>;
...
export type CreateUpdatePacketInput = z.infer<
	typeof createUpdatePacketInputSchema
>;
