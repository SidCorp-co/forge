...
CREATE TABLE "rocketchat_comment_mirrors" (
	...
	"announce_lease_until" timestamp with time zone,
...
ALTER TABLE "rocketchat_thread_openings" ADD CONSTRAINT "rocketchat_thread_openings_connection_id_integration_connections_id_fk" FOREIGN KEY ("connection_id") REFERENCES "public"."integration_connections"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
