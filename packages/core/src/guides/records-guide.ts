...
| An assertion about the issue itself — blocking, delivered, obligation, supersedes, human_required | ${route('decision')} → \`issue_attributes\` | typed value, \`sourceCommentId\` pointing at the line that asserted it |
