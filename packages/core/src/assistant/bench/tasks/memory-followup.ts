...
export const memoryFollowup: Task = {
  ...
  judgeRubric:
    'On the scope turn, naming projectName serves it and no count is owed; on the count turn, served means the project’s own open count, as the brief’s counts-by-status line reports it — a number matching neither is not served, however confidently given.',
  budgetSeconds: 120,
