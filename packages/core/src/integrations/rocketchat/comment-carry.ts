...
// real rule and refuses on what it finds. `admitted` is that mint, and `verdict-mint.test.ts` holds the
// list of files allowed to call it — a reply path that wants to declare its own text passed has to
