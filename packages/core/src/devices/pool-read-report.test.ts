...
/**
 * The bytes the box puts on the heartbeat. forge-runner's heartbeat tests assert
 * the same file on the producing side, from a record planted through its writer.
 */
