...
- **forge_config** — read/write per-project settings: baseBranch, repoPath, productionBranch, categories, pipelineConfig, projectFacts (+ projectFactsConfig for the always-inject tier).
